...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import ManusSEOOptimizer
        ...
        optimizer = ManusSEOOptimizer(config)
    ...
    try:
        from site_generator import ManusSiteGenerator
        site_gen = ManusSiteGenerator(config)
        site_gen.build_site()
